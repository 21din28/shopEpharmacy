...
class MailController extends Controller
{
    ...
    public function reset_new_pass_admin(Request $request){
        ...
        if($user){
                ...
                $reset->save();
                return redirect('admin')->with('message', 'Mật khẩu đã cập nhật mới,vui lòng đăng nhập');
        }else{
            return redirect('quen-mat-khau-admin')->with('error', 'Vui lòng nhập lại email vì link đã quá hạn');
        }
    }
    ...
    public function quen_mat_khau_admin(Request $request){

       return view('admin.recoverpass.forget_pass'); 
       
    }
    public function update_new_pass_admin(Request $request){

        return view('admin.recoverpass.update_new_pass'); 
