...
class HomeController extends Controller
{
    ...
    public function load_more_product(Request $request){
        ...
        if(!$all_product->isEmpty()){
            foreach($all_product as $key => $pro){
             ...
             $output .= '
                <div id="load_more">
                    <button type="button" name="load_more_button" class="btn btn-default form-control" data-id="'.$last_id.'" id="load_more_button">Load thêm sản phẩm
                    </button>
                </div>
            ';
        }else{
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Chuyên bán những sản phẩm, thiết bị y tế uy tin"; 
        $meta_keywords = "y te, thiet bi te, san pham y te";
        $meta_title = "E-Pharmacy";
