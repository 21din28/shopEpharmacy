...
Route::get('/quen-mat-khau','MailController@quen_mat_khau_admin');
...
Route::get('/quen-mat-khau-admin','MailController@quen_mat_khau_admin')->name('quen-mat-khau-admin');
Route::get('/update-new-pass-admin','MailController@update_new_pass_admin');
Route::post('/recover-pass-admin','MailController@recover_pass_admin');
Route::post('/reset-new-pass-admin','MailController@reset_new_pass_admin');
