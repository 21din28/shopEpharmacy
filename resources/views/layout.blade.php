                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box">
                           ...
                           <input type="submit" style="margin-top:0;color:#666" name="search_items" class="btn btn-default btn-sm" value="Tìm kiếm">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="single-widget">
                            ...
                            <style>ul.nav.nav-pills.nav-stacked.doitac {
                                padding: 0;
                                margin: 0;
                                list-style: none;
                            }
                            ul.nav.nav-pills.nav-stacked.doitac li {
                                    float: left;
                                    margin: 10px;
                                }</style>
                            <ul class="nav nav-pills nav-stacked doitac">
                                @foreach($icons_doitac as $key => $icon)
                                <li><a target="_blank" href="{{$icon->link}}"><img width="100" height="90" src="{{asset('/public/uploads/icons/'.$icon->image)}}">
                                    <h5>{{$icon->name}}</h5>
                                </a></li>
                                @endforeach
